...
import { replacePhaseTooling } from "@/app/actions/phases";
import type { PhaseTooling, ToolType } from "@/lib/types";
...
export function PhaseToolingEditor({
  phaseId,
  tooling,
  onCancel,
  onSaved,
  ...
  function handleSave() {
    ...
    startTransition(async () => {
      const result = await replacePhaseTooling(phaseId, payload);
      if (result.error) {
